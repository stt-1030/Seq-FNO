...
class SpectralConv1d(nn.Module):
    ...
    def forward(self, x):
        ...
        #print('1111111',x_ft.shape)# [1, 128, 3]
...
dataloader = MatReader('50_step_pred_5000/data_ti.mat')
...
# 循环读取每个 .mat 文件
for i in range(1, 3):
    file_name = f'50_step_pred_5000/data_next_{i}.mat'
...
y_train=torch.hstack(y_next_train)#(1000,40)
y_test=torch.hstack((y_next_test))#(1000,40)
...
dataloadera = MatReader('50_step_pred_5000/IC_H_1_8.mat')
dataloaderu = MatReader('50_step_pred_5000/muti_time/u_1.0.mat')
...
for i in range(49):
    ...
    dataloader = MatReader('100_step_pred_5000/muti_time/u_{:.1f}'.format(2+i*1))
